...
/**
 * The Trdpb007 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Trdpb007 trdpb007 = (Trdpb007) context.getBean("trdpb007");
        	    trdpb007.process(new GlobalExecutorCtx().getContext(Trdpb007Ctx.class)); /*  Trdpb007 requires no input parameters  */
